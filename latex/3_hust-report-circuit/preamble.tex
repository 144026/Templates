...
%----------headers------------------------
\usepackage{fancyhdr}
\fancyhead[L]{\small \kaishu \ClassName}
\fancyhead[R]{\small \kaishu \ReportName}
%----------headers------------------------
...
\renewcommand{\figureautorefname}{图\hspace{-2pt}}
\renewcommand{\subfigureautorefname}{图\hspace{-2pt}}
\renewcommand{\tableautorefname}{表\hspace{-2pt}}
\renewcommand{\subtableautorefname}{表\hspace{-2pt}}
%----------xref--------------------------
...
\tocloftpagestyle{empty} % this package overwrites pagestyle!
%----------toc------------------------------ 
...
%----------marcos--------------------------
\newcommand{\ClassName}{通信电子线路}
\newcommand{\ReportName}{xxxx实验报告}
%----------marcos--------------------------
